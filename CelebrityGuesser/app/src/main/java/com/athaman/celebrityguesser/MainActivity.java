package com.athaman.celebrityguesser;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String result;
        imageView = (ImageView) findViewById(R.id.celebImage);
    ...
    public void celebrityPicked(View view){
        if(view.getTag().toString().equals(Integer.toString(locationOfAnswer))){
            Toast.makeText(getApplicationContext(), "Correct Answer!", Toast.LENGTH_SHORT).show();
        }else{
            String name = celebNames.get(chosenCeleb);
            Toast.makeText(getApplicationContext(), "Not quite... it was " + name, Toast.LENGTH_SHORT).show();
        }
        setQuestion();
    }
